      ...
      <div className="space-y-6 rounded-2xl border-2 border-slate-200 p-4">
        ...
        <div>
          ...
          <p className="mb-3 text-sm text-slate-500">
            ...
            ביניהם בתמונה, לא לגזעים שבאמת שונים. רלוונטי לפרמטרים שמשתמשים בשיטת ההשוואה "גזע". השוואת גזע מדלגת רק
            כששני הצדדים מסומנים כ"מעורב" (ברירת המחדל) - ברגע שצד אחד ציין גזע ספציפי, ההשוואה כן מתבצעת במדויק,
            וגם "מעורב" בצד השני נחשב אי-התאמה, אלא אם הוגדרה כאן קבוצה שכוללת את שניהם.
          </p>
          <div className="space-y-3">
