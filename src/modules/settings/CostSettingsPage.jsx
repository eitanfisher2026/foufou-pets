    ...
    <div className="p-4 pb-10">
      ...
      <CollapsibleSection icon="📷" title="השוואת תמונות AI">
        ...
        <p className="mb-2 mt-4 text-sm text-slate-500">
          שלב 1 - מתי בכלל להפעיל את ההשוואה: ה-AI לא רץ על כל זוג, רק על התאמות שכבר הגיעו לרמת הסבירות הזו לפי
          הפרטים (צבע, גזע, מיקום וכו'). "כבוי" מבטל את ההשוואה כליל, בלי קשר לספק שנבחר למעלה.
        </p>
        <SelectField
        ...
        <p className="mb-2 mt-4 text-sm text-slate-500">
          שלב 2 - מה עושים עם התוצאה: ההשוואה מחזירה רמה - "סבירות גבוהה"/"בינונית"/"נמוכה" שמדובר באותה חיה, או
          "בוודאות אין התאמה". <strong>הדרופדאון הזה, לא הקודם</strong>, קובע איפה לפסול: רמה שמגיעה לסף שנבחר כאן
          פוסלת את ההתאמה לגמרי (ציון 0), בדיוק כמו אי-התאמת צבע או גזע - לא רק מוצגת כהערה. לכן אין כאן אפשרות
          "בינונית"/"גבוהה" לבחירה - לא הגיוני לפסול התאמה כי ה-AI חושב שזו דווקא כן אותה חיה. "כבוי" משאיר את
          התוצאה כהערה מידעית בלבד, בלי להשפיע על הציון.
        </p>
        <SelectField
          className="w-full max-w-[12rem]"
