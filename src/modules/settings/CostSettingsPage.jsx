    ...
    <div className="p-4 pb-10">
      ...
      <section className="mb-6 rounded-xl border border-slate-200 bg-white p-4">
        ...
        <p className="mt-2 text-xs font-medium text-amber-700">
          שימו לב: המעקב לפי משתמש הופעל ב-11.9.2026. הוא כולל רק שימוש מאותו תאריך ואילך - עלות מלפני כן (כולל את
          רוב הסכום שמופיע למעלה תחת "עלות AI") לא נרשמה עם זהות משתמש בזמנו, ולכן לא ניתן לשייך אותה למשתמש ספציפי
          רטרואקטיבית. פערים גדולים בין הסכום הכולל לסכומים כאן צפויים כתוצאה מזה, לא סימן לבעיה.
        </p>
      </section>
