...
export default function FoundReportForm() {
  ...
  const [fields, setFields] = useState(() => ({
    ...
    breed: preferredSpecies === SPECIES.CAT ? DEFAULT_CAT_BREED : EMPTY_FOUND_FIELDS.breed,
  }));
    ...
    <form onSubmit={handleSubmit} className="space-y-5 p-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <InfoButton title={labels.infoButtonTitle}>
          <p>אין צורך להכיר את מי שכתב את הפוסט. כמה דרכים להוסיף מידע, גם ביחד - ואז ללחוץ "זיהוי אוטומטי":</p>
