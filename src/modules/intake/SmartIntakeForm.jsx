    ...
    <div className="space-y-5 p-4">
      ...
      {isIOS && (
        <p className="rounded-xl border border-amber-200 bg-amber-50 p-3 text-xs leading-relaxed text-amber-800">
          ...
          לעקיפה. הדרך להוסיף פוסט מפייסבוק: מדביקים את הקישור או הטקסט שלו, או מעלים צילום מסך - כאן ב"הוספה חכמה"
          (אם לא בטוחים אם זה חתול/כלב ואם זו אבידה או מציאה), או ישירות בטופס הספציפי אם כבר יודעים.
        </p>
      )}
