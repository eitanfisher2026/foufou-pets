  ...
  return (
    <div className="mx-auto max-w-2xl p-4">
      ...
      <section className="mb-8">
        ...
        {lostCases.length === 0 && !loading && <p className="text-sm text-slate-400">אין תיקים פתוחים עדיין.</p>}
      ...
      <section>
        ...
        {foundReports.length === 0 && !loading && <p className="text-sm text-slate-400">אין דיווחים עדיין.</p>}
        <ul className="space-y-2">
          {foundReports.map((r) => (
