...
export const GETTING_STARTED_CARDS = [
  ...
  },
  {
    ...
    body: 'באנדרואיד: אחרי התקנת האפליקציה למסך הבית (מתפריט החשבון ⚙️ ← "התקנת האפליקציה"), אפשר ללחוץ "שיתוף" על פוסט בפייסבוק ולבחור "איתור חיות מחמד" מרשימת האפשרויות - בלי התקנה, האפליקציה פשוט לא תופיע שם. באייפון האפשרות הזו לא קיימת בכלל, גם עם התקנה (מגבלה של אפל) - יש להשתמש ב"הוספה חכמה" ולהעלות שם צילום מסך של הפוסט.',
  },
  {
    icon: '✨',
