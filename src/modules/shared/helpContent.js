...
export const GETTING_STARTED_CARDS = [
  ...
  {
    icon: '📲',
    title: '4. שיתוף ישיר מפייסבוק (Meta) - אנדרואיד בלבד',
    body: 'באנדרואיד: אחרי התקנת האפליקציה למסך הבית (מתפריט החשבון ⚙️ ← "התקנת האפליקציה"), אפשר ללחוץ "שיתוף" על פוסט בפייסבוק ולבחור "איתור חיות מחמד" מרשימת האפשרויות - בלי התקנה, האפליקציה פשוט לא תופיע שם. באייפון האפשרות הזו לא קיימת בכלל, גם עם התקנה (מגבלה של אפל) - אבל אפשר תמיד להעתיק את הקישור לפוסט או את הטקסט שלו, או לצלם מסך שלו, ולהדביק/להעלות ב"הוספה חכמה" (אם לא בטוחים מה זה) או ישירות בטופס הספציפי (חתול/כלב, אבד/נמצא) אם כבר יודעים.',
  },
  {
    icon: '✨',
