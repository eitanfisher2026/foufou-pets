            ...
            {!installed && isIOS && (
              <div className="rounded-xl border border-amber-200 bg-amber-50 p-3">
                ...
                <p className="mb-1 text-xs leading-relaxed text-amber-800">
                  ...
                  ניתנת לעקיפה, גם אם האפליקציה מותקנת. במקום זאת: מדביקים את הקישור או הטקסט של הפוסט, או מעלים
                  צילום מסך שלו - ב"הוספה חכמה" (אם לא בטוחים מה זה) או ישירות בטופס הספציפי אם כבר יודעים. זה עובד
                  מצוין, רק בלי תפריט השיתוף של הטלפון.
                </p>
                <button
                  type="button"
                  onClick={handleInstallClick}
