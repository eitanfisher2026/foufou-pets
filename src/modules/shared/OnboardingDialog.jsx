 ...
 * just hides it without marking anything as seen. Leads with installing to
 * the home screen, since that's a real prerequisite (not just a nice-to-
 * have) for the Facebook share-to-app flow described in the help text
 * below it - Android's share sheet only offers an installed PWA as a
 * target, never a browser tab. Reuses the exact same admin-editable "how
 * does this work" text as HelpDialog.jsx, read-only here, so there's only
 * ever one copy of that explanation to keep current.
 */
        ...
        <div className="space-y-4 p-4">
          ...
          {!installed && (canPrompt || isIOS) && (
            <div className="rounded-xl border border-amber-200 bg-amber-50 p-3">
              <p className="mb-2 text-sm font-medium text-amber-900">📲 שלב ראשון: התקנה למסך הבית</p>
          ...
          <div>
            <p className="mb-2 text-sm font-medium text-slate-700">איך זה עובד</p>
            {helpText === null ? (
